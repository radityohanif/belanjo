<div class="container mt-5">
	...
	<div class="row mt-5">
		<?php 
			...
			$kategori[0]['label'] = 'Makanan pokok';
		...
		<?php foreach ($kategori as $k): ?>
			<div class="col-6 col-lg-2 text-center membesar" style="padding-bottom: 50px; padding-top: 20px;" data-aos="fade-up" onclick="document.location=">
				<a href="<?= BASEURL ?>/home/kategori/<?= $k['label'] ?>" style="text-decoration: none; color: black;">
